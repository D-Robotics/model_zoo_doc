...
This repository contains the source code for the Model Zoo development documentation site, built with Docusaurus. It includes the main Chinese documentation, English translations, site theme customization, document scope filtering (Doc Scope), and an automated release process.
...
- English: `http://localhost:3000/en/model_zoo_doc/model_zoo_intro`
- Chinese: `http://localhost:3000/model_zoo_doc/model_zoo_intro`
